...
var G__47140 = o;
goog.object.set(G__47140,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__47141 = o;
goog.object.set(G__47141,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
G__47161.cljs$lang$applyTo = (function (arglist__47163){
var args = cljs.core.seq(arglist__47163);
...
var G__47142 = props;
var G__47142__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47142,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__47142);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47142__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__47143 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47143,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__47143;
}
})(),id_class);
...
var G__47144 = (cljs.core.count(argv) - first_child);
switch (G__47144) {
case (0):
...
var vec__47145 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47145,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47145,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47145,(2),null);
...
var temp__5739__auto___47169 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___47169 == null)){
} else {
var key_47170 = temp__5739__auto___47169;
(jsprops.key = key_47170);
}
...
var temp__5739__auto___47177 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___47177 == null)){
} else {
var key_47178 = temp__5739__auto___47177;
(jsprops.key = key_47178);
}
...
var temp__5739__auto___47181 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___47181 == null)){
} else {
var key_47182 = temp__5739__auto___47181;
(jsprops.key = key_47182);
}
...
var temp__5739__auto___47186 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___47186 == null)){
} else {
var key_47187 = temp__5739__auto___47186;
(jsprops.key = key_47187);
}
...
var temp__5739__auto___47188 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___47188 == null)){
} else {
var key_47189 = temp__5739__auto___47188;
(jsprops.key = key_47189);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47148_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__47148_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__47149 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47149,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47149,(1),null);
...
break;
default:
var G__47206 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__47207 = compiler;
v = G__47206;
compiler = G__47207;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template47155 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template47155 = (function (opts,id,fn_to_element,meta47156){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template47155.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_47157,meta47156__$1){
var self__ = this;
var _47157__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template47155(self__.opts,self__.id,self__.fn_to_element,meta47156__$1));
}));

(reagent.impl.template.t_reagent$impl$template47155.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_47157){
var self__ = this;
var _47157__$1 = this;
return self__.meta47156;
}));

(reagent.impl.template.t_reagent$impl$template47155.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template47155.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template47155.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template47155.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template47155.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta47156","meta47156",-1008477095,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template47155.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template47155.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template47155");

(reagent.impl.template.t_reagent$impl$template47155.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template47155");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template47155.
 */
reagent.impl.template.__GT_t_reagent$impl$template47155 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template47155(opts__$1,id__$1,fn_to_element__$1,meta47156){
return (new reagent.impl.template.t_reagent$impl$template47155(opts__$1,id__$1,fn_to_element__$1,meta47156));
});

}

return (new reagent.impl.template.t_reagent$impl$template47155(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
